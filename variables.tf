...
variable "waf_blocked_countries" {
  ...
  type        = list(string)
  default     = ["CN", "RU", "KP"] # China, Russia, North Korea
}

variable "allowed_ip_addresses" {
  description = "List of IP addresses allowed to bypass WAF restrictions"
  type        = list(string)
  default     = []
}
...
variable "cognito_domain_prefix" {
  ...
  type        = string
  default     = "bank-app-auth"
}

variable "admin_email" {
  description = "Admin email for initial Cognito user creation"
  type        = string
  default     = ""
}
